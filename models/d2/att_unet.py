...
class Att_UNet(nn.Module):
    def __init__(self, num_classes=1, num_channels=1, scale_factor=2, dropout=0):
        ...
        self.Conv2 = conv_block(
            ch_in=filters[0], ch_out=filters[1], dropout=dropout)
        self.Conv3 = conv_block(
            ch_in=filters[1], ch_out=filters[2], dropout=dropout)
        self.Conv4 = conv_block(
            ch_in=filters[2], ch_out=filters[3], dropout=dropout)
        self.Conv5 = conv_block(
            ch_in=filters[3], ch_out=filters[4], dropout=dropout)
        ...
        self.Up_conv5 = conv_block(
            ch_in=filters[4], ch_out=filters[3], dropout=dropout)
        ...
        self.Up_conv4 = conv_block(
            ch_in=filters[3], ch_out=filters[2], dropout=dropout)

        self.Up3 = up_conv(ch_in=filters[2], ch_out=filters[1])
        self.Att3 = Attention_block(
            F_g=filters[1], F_l=filters[1], F_int=filters[0])
        self.Up_conv3 = conv_block(
            ch_in=filters[2], ch_out=filters[1], dropout=dropout)
